...
if __name__ == '__main__':
    ...
    # detect faces on background images to use as hard negatives and re-train Realboost classifier, starting with weights
    # from last iteration of Realboost training
